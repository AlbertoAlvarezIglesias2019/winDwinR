...
//'
//' @description
//' Calculates the probability of a favorable pair, defined as \eqn{P(X - Y > \lambda)},
//' across a vector of thresholds \eqn{\lambda}. This is equivalent to \eqn{1 - P(Z \le \lambda)}
...
//' @export
// [[Rcpp::export]]
 NumericVector c_win(NumericVector x_uni, NumericVector x_w,
